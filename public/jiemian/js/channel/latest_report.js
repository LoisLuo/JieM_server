...
var app = {
	...
	createLReportItem: function(list) {
		var Item = ['<div class="LR_item" data-new_list="{@id}">',
			...
			'<a target="_blank" href="http://127.0.0.1:8020/jiemian/article.html">',
			...
			'<h2>',
			'<a target="_blank" href="http://127.0.0.1:8020/jiemian/article.html" class="">{@title}</a>',
			'</h2>',
			'</div>',
		...
		//把分类拆成数组放入span中
			...
			var tag='<a target="_blank" href="http://127.0.0.1:8020/jiemian/article.html" class=""><span>{@tags}</span></a>';
			var arr=[];
