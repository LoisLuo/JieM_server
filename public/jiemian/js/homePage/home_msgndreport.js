var msgAndReport = {
	...
	msgItem: function(list) {
		tpl = [
			...
			'<a target="_blank" href="http://127.0.0.1:8020/jiemian/article.html"><div>{@title}</div></a>',
			'</span>',
			'</li>',
			'</ul>'
		];
	...
	newsItem: function(list) {
		...
		var tpl = [
			...
			'<h2><a target="_blank" href="http://127.0.0.1:8020/jiemian/article.html">{@title}</a></h2>',
			'</div>',
