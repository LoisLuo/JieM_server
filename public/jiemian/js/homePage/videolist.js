	...
	videoBox:function(list){
		var tpl=[
			'<div class="video_item content_video{@cid}" data-video_item="{@id}">',
				'<div class="video_img">',		
				'<a target="_blank" href="http://127.0.0.1:8020/jiemian/video.html" class="">',
					'<img src="{@img}" alt="" />',	
					'<div><i class="iconfont icon-shipin2"></i></div>',
				'</a>',
				'</div>',
				'<div class="video_title"><a target="_blank" href="http://127.0.0.1:8020/jiemian/video.html">{@title}</a></div>',
